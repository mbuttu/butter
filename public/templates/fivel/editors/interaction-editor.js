...
(function( Butter ) {
  Butter.Editor.register( "interaction", "load!{{baseDir}}templates/fivel/editors/interaction-editor.html",
    ...
    function setup( trackEvent ) {
      ...
      function attachHandlers() {
        ...
        function processCombo( OS ) {
          _mousetrapHelper.bindInputTag( element, sequences[ OS + "Sequence" ], unblockShortcuts,
                                         blockShortcuts, function( newSequence ) {
            var newOptions = {};
        ...
        container.insertBefore( _this.createStartEndInputs( trackEvent, _this.updateTrackEventSafe ),
