...
(function( Butter ) {
  ...
  Butter.Editor.register( "hotspot", "load!{{baseDir}}templates/fivel/editors/hotspot-editor.html",
    ...
    function setup( trackEvent ) {
      ...
      // It will only ever be an empty string on startup or an Array.
      // Object is a suitable enough check.
      if ( typeof _frames !== "object" ) {
        _frames = [];
      }
